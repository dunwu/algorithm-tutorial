...
public class 二叉树中的伪回文路径 {
    ...
    public static void main(String[] args) {
        Assertions.assertEquals(2,
            new Solution().pseudoPalindromicPaths(TreeUtils.buildTree(2, 3, 1, 3, 1, null, 1)));
        Assertions.assertEquals(1,
            new Solution().pseudoPalindromicPaths(TreeUtils.buildTree(2, 1, 1, 1, 3, null, null, null, null, null, 1)));
    }
