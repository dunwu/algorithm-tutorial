...
public class 从叶结点开始的最小字符串 {
    ...
    public static void main(String[] args) {
        Assertions.assertEquals("dba",
            new Solution().smallestFromLeaf(TreeNode.buildTree(0, 1, 2, 3, 4, 3, 4)));
        Assertions.assertEquals("adz",
            new Solution().smallestFromLeaf(TreeNode.buildTree(25, 1, 3, 1, 3, 0, 2)));
        Assertions.assertEquals("abc",
            new Solution().smallestFromLeaf(TreeNode.buildTree(2, 2, 1, null, 1, 0, null, 0)));
    }
