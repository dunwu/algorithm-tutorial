...
public class 从未排序的链表中移除重复元素 {
    ...
    public static void main(String[] args) {
        ListNode head = ListNode.buildList(1, 2, 3, 2);
        ...
        ListNode head2 = ListNode.buildList(2, 1, 1, 2);
        ...
        ListNode head3 = ListNode.buildList(3, 2, 2, 1, 3, 2, 4);
        System.out.println(ListNode.toList(head3));
        ListNode result3 = deleteDuplicates2(head3);
        List<Integer> list3 = ListNode.toList(result3);
