...
public class 求根节点到叶节点数字之和 {
    ...
    public static void main(String[] args) {
        Assertions.assertEquals(25, new Solution().sumNumbers(TreeUtils.buildTree(1, 2, 3)));
        Assertions.assertEquals(1026, new Solution().sumNumbers(TreeUtils.buildTree(4, 9, 0, 5, 1)));
    }
