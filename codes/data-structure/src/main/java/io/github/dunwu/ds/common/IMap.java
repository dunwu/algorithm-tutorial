...
/**
 * In computer science, an associative array, map, or dictionary is an abstract data type
 * composed of a collection of (key, value) pairs, such that each possible key appears at
