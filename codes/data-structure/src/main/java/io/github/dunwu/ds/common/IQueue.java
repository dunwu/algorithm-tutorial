 ...
 * collection are the addition of entities to the rear terminal position and removal of
 * entities from the front terminal position. This makes the queue a First-In-First-Out
 * (FIFO) data structure. In a FIFO data structure, the first element added to the queue
